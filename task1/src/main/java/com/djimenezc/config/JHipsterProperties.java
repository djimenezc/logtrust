...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "LogAnalyzer@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "LogAnalyzer API";

        private String description = "LogAnalyzer API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "LogAnalyzer";
